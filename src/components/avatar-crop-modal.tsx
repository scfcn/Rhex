    ...
    >
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1.35fr)_320px]">
        <div className="space-y-3">
          <div className="relative h-[360px] overflow-hidden rounded-[24px] border border-border bg-[radial-gradient(circle_at_top,_rgba(251,191,36,0.16),_transparent_42%),linear-gradient(135deg,rgba(15,23,42,0.03),rgba(15,23,42,0.08))]">
            <Cropper
              image={imageSrc}
              crop={crop}
              zoom={zoom}
