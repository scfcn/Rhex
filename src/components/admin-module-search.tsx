...
const ADMIN_MODULE_SEARCH_ITEMS: AdminModuleSearchItem[] = [
  ...
  { href: "/admin?tab=settings&section=profile&subTab=branding", label: "品牌基础", category: "站点设置子页", description: "配置站点名称、Logo 文案和 Slogan。", keywords: ["品牌基础", "站点名称", "logo文案", "slogan"] },
  ...
  { href: "/admin?tab=settings&section=interaction&subTab=content-limits", label: "内容限制", category: "站点设置子页", description: "配置发帖标题、正文、回复的字数限制，以及帖子和评论的可编辑时长。", keywords: ["内容限制", "标题最小字数", "标题最大字数", "正文最小字数", "正文最大字数", "回复最小字数", "回复最大字数", "字数限制", "帖子可编辑分钟数", "评论可编辑分钟数", "编辑时效", "编辑分钟数"] },
