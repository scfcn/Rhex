...
const ADMIN_MODULE_SEARCH_ITEMS: AdminModuleSearchItem[] = [
  ...
  { href: "/admin?tab=settings&section=interaction&subTab=comment-tip", label: "评论与打赏", category: "站点设置子页", description: "配置游客评论可见性、帖子打赏限制和礼物列表。", keywords: ["评论与打赏", "游客可查看评论", "帖子打赏", "每日可打赏次数", "单帖可打赏次数", "裸积分打赏档位", "礼物打赏"] },
  { href: "/admin?tab=settings&section=interaction&subTab=reward-pool", label: "红包与聚宝盆", category: "站点设置子页", description: "配置帖子红包、聚宝盆积分池和中奖概率。", keywords: ["红包与聚宝盆", "帖子红包", "红包最大积分", "每日发红包积分上限", "聚宝盆", "初始积分", "回复递增积分", "回复中奖概率"] },
