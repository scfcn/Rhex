    ...
    <>
      ...
      {availableSourceIds.length > 0 ? (
        <div className="fixed bottom-4 right-4 z-50 flex items-end justify-end sm:bottom-5 sm:right-5">
          {panelOpen ? (
            <div className="fixed inset-x-3 bottom-20 z-50 overflow-hidden rounded-[22px] border border-border bg-background shadow-[0_24px_64px_rgba(15,23,42,0.18)] sm:absolute sm:inset-x-auto sm:bottom-[calc(100%+0.75rem)] sm:right-0 sm:w-[min(30rem,calc(100vw-2.5rem))] lg:w-[34rem]">
