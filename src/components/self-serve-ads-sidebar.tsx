    ...
    <section className="rounded-[24px] border border-border bg-card p-4 shadow-xs shadow-black/5 dark:shadow-black/30">
      ...
      <div className="space-y-2">
        {resolvedPanelData.imageSlots.map((item) => item.isPlaceholder ? (
          ...
          <a key={item.id} href={item.linkUrl ?? "#"} target="_blank" rel="noreferrer" className="block overflow-hidden border border-border bg-background transition hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/5">
