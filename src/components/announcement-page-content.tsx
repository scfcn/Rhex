    ...
    <div className="space-y-6">
      ...
      <AddonSurfaceRenderer surface="announcements.content" props={{ items }}>
        <section className="space-y-4">
          {items.map((item) => (
            <article key={item.id} id={item.id} className="rounded-xl border border-border bg-card p-6">
              ...
              {item.sourceType === "DOCUMENT" ? (
                <div className="mt-4 rounded-xl border border-border/70 bg-background px-5 py-4">
